...
unittest
{
    ...
    foreach(destinationEntry; destination["root"].dirEntries(SpanMode.breadth))
    {
        assert(
            (destinationEntry.name in destinationPaths) != null,
            "Expected " ~ destinationEntry.name ~ " to be in destinationPaths, but it wasn't"
        );
    }
